avList = {
	"Deep Security Manager.exe": "亚信安全终端",
    "/klnagent64": "卡巴斯基EDR",
    "/klnagent": "卡巴斯基EDR",
    "/wdserver": "卡巴斯基EDR",
    "/kesl_launcher.sh": "卡巴斯基EDR",
    "/kesl": "卡巴斯基EDR",
    "TitanAgent.exe": "青藤EDR",
    "TitanMonitor.exe": "青藤EDR",
    "QAXEntClient.exe": "QAX天擎",
    "360EntClient.exe": "360天擎",
    "skylards.exe": "360天擎数据服务组件",
    "360skylarsvc.exe": "360天擎服务",
    "reportsteward.exe": "QAX终端安全管理系统-接入组件",
    "jmpserv.exe": "360天擎NAC RPC服务",
    "skydasgosdk.exe": "QAX-天擎6 Skydas-go-sdk组件",
    "skylarcentral.exe": "QAX-天擎6服务端组件",
    "skylarcron.exe": "QAX-天擎6服务端组件",
    "skylarminide.exe": "QAX-天擎6报表组件",
    "skytime.exe": "QAX-天擎6",
    "skylarapi.exe": "QAX-天擎API组件",
